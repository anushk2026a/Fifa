    ...
    restaurants: {
      "2mi": [
        ...
        place(
          ...
          "Patriot Place, Foxborough, MA",
          "American bar & grill · $$",
          "/images/places/bar-louie-foxborough.jpg",
        ),
        place(
          ...
          "Patriot Place, Foxborough, MA",
          "New England seafood · $$",
          "/images/places/skipjacks-foxborough.jpg",
        ),
        place(
          "Twin River Social Restaurant",
          "Foxborough MA",
          0.3,
          "Patriot Place, Foxborough, MA",
          "Sports bar & grill · $$",
          "/images/places/twin-river-foxborough.jpg",
        ),
      ],
      "5mi": [
        place(
          ...
          "Foxborough MA",
          2.4,
          "56 South St, Foxborough, MA",
          "Italian · $$",
          "/images/places/bellaggio-foxborough.jpg",
        ),
        place(
          "Blackfin Chophouse + Raw Bar",
          "Walpole MA",
          4.2,
          "950 Providence Hwy, Walpole, MA",
          "Steakhouse & seafood · $$$",
          "/images/places/blackfin-chophouse.jpg",
        ),
        place(
          "Craft Beer Cellar Foxborough",
          "Foxborough MA",
          0.3,
          "10 Patriot Pl, Foxborough, MA",
          "Craft beer bar · $",
          "/images/places/craft-beer-cellar-foxborough.jpg",
        ),
      ],
    },
    hotels: {
    ...
    restaurants: {
      "2mi": [
        place(
          ...
          "Houston TX",
          1.5,
          "2515 S Loop W, Houston, TX",
          "Tex-Mex · $$",
          "/images/places/pappasitos-houston.jpg",
        ),
        place(
          "Buffalo Wild Wings South Loop",
          "Houston TX",
          1.6,
          "8130 S Main St, Houston, TX",
          "Wings & sports bar · $$",
          "/images/places/bdubs-houston-southloop.jpg",
        ),
      ],
      "5mi": [
        place(
        ...
        place(
          ...
          "Upscale Mexican · $$$",
          "/images/places/hugos-houston.jpg",
        ),
        place(
          "The Pit Room",
          "Houston TX",
          ...
          "Texas BBQ · $$",
          "/images/places/the-pit-room-houston.jpg",
        ),
      ],
    },
    hotels: {
    ...
    restaurants: {
      "2mi": [
        place(
          ...
          "Soul food · $$",
          "/images/places/serving-spoon-inglewood.jpg",
        ),
        place(
          "Harold & Belle's",
          "Los Angeles CA",
          ...
          "Creole · $$",
          "/images/places/harold-and-belles.jpg",
        ),
        place(
          "Earle's on Crenshaw",
          "Los Angeles CA",
          2.0,
          "3864 Crenshaw Blvd, Los Angeles, CA",
          "Vegan soul food · $$",
          "/images/places/earles-on-crenshaw.jpg",
        ),
      ],
      "5mi": [
        place(
        ...
        place(
          ...
          "Los Angeles CA",
          3.2,
          "3446 W Slauson Ave, Los Angeles, CA",
          "BBQ · $",
          "/images/places/woodys-bbq-la.jpg",
        ),
        place(
          "Hilton's Chicken",
          "Inglewood CA",
          1.2,
          "201 N Market St, Inglewood, CA",
          "Fried chicken · $",
          "/images/places/hiltons-chicken-inglewood.jpg",
        ),
      ],
    },
    hotels: {
    ...
    restaurants: {
      "2mi": [
        place(
          ...
          "Philadelphia PA",
          0.9,
          "14 E Snyder Ave, Philadelphia, PA",
          "Philly roast pork & cheesesteaks · $",
          "/images/places/johns-roast-pork.jpg",
        ),
        place(
          "Sarcone's Deli",
          "Philadelphia PA",
          1.8,
          "734 S 9th St, Philadelphia, PA",
          "Italian hoagies · $",
          "/images/places/sarcones-deli.jpg",
        ),
        place(
          "Termini Bros Bakery",
          "Philadelphia PA",
          1.6,
          "1523 S 8th St, Philadelphia, PA",
          "Italian bakery & cannoli · $",
          "/images/places/termini-bros-bakery.jpg",
        ),
      ],
      "5mi": [
        place(
        ...
        place(
          ...
          "Historic indoor food market · $",
          "/images/places/reading-terminal-market.jpg",
        ),
        place(
          "Zahav",
          "Philadelphia PA",
          3.5,
          "237 St James Pl, Philadelphia, PA",
          "Israeli fine dining · $$$",
          "/images/places/zahav-philadelphia.jpg",
        ),
      ],
    },
    hotels: {
    ...
    restaurants: {
      "2mi": [
        ...
        place(
          ...
          "Italian deli · $",
          "/images/places/salumi-seattle.jpg",
        ),
        place(
          "Pike Place Chowder",
          "Seattle WA",
          ...
          "Clam chowder · $$",
          "/images/places/pike-place-chowder.jpg",
        ),
        place(
          ...
          "Pacific NW seafood · $$$",
          "/images/places/matts-in-the-market.jpg",
        ),
      ],
      "5mi": [
        place(
          ...
          "Seattle WA",
          2.6,
          "115 Broadway E, Seattle, WA",
          "Iconic Seattle burgers · $",
          "/images/places/dicks-drive-in-seattle.jpg",
        ),
        place(
          "Canlis",
          "Seattle WA",
          ...
          "/images/places/canlis-seattle.jpg",
        ),
        place(
          ...
          "Oyster bar & seafood · $$",
          "/images/places/taylor-shellfish-seattle.jpg",
        ),
      ],
    },
    hotels: {
    ...
    restaurants: {
      "2mi": [
        place(
          ...
          "Toronto",
          0.6,
          "165 East Liberty St, Toronto, ON",
          "Irish pub & kitchen · $$",
          "/images/places/brazen-head-toronto.jpg",
        ),
        place(
          "Buca Osteria & Bar",
          "Toronto",
          ...
          "Italian · $$$",
          "/images/places/buca-toronto.jpg",
        ),
        place(
          "Lavelle",
          "Toronto",
          ...
          "/images/places/lavelle-toronto.jpg",
        ),
      ],
      "5mi": [
        place(
          ...
          "/images/places/st-lawrence-market.jpg",
        ),
        place(
          "Canoe",
          "Toronto",
          2.6,
          "66 Wellington St W (54F), Toronto, ON",
          "Fine dining — Canadian · $$$$",
          "/images/places/canoe-toronto.jpg",
        ),
        place(
          "Bar Isabel",
          "Toronto",
          ...
          "Spanish tapas · $$$",
          "/images/places/bar-isabel-toronto.jpg",
        ),
      ],
    },
    hotels: {
    ...
    restaurants: {
      "2mi": [
        place(
          ...
          "Aburi sushi · $$$",
          "/images/places/minami-vancouver.jpg",
        ),
        place(
          ...
          "/images/places/homer-street-cafe.jpg",
        ),
        place(
          ...
          "Fine dining · $$$$",
          "/images/places/hawksworth-vancouver.jpg",
        ),
      ],
      "5mi": [
        place(
          ...
          "/images/places/miku-vancouver.jpg",
        ),
        place(
          "L'Abattoir",
          "Vancouver",
          ...
          "French-West Coast · $$$",
          "/images/places/labattoir-vancouver.jpg",
        ),
        place(
          ...
          "Modern Chinese · $$",
          "/images/places/bao-bei-vancouver.jpg",
        ),
      ],
    },
    hotels: {
